...
class ISchemaInfo(Interface):
    """Information about a schema and associated metadata
    """
...
class IModel(Interface):
    ...
    schemata = zope.schema.Dict(title=u"Schemata",
                                key_type=zope.schema.ASCIILine(title=u"Schema name",
                                                               description=u"Default schema is under the key u''."),
                                value_type=zope.schema.Object(title=u"Schema and metadata",
                                                               schema=ISchemaInfo))
